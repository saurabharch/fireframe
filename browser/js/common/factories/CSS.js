app.factory('CSS', function() {
	var styles = ['width', 'height', 'font-size', 'color', 'opacity', 'border-width', 'border-style', 'border-radius', 'border-color', 'background-color', 'background-image', 'background-size', 'z-index'];
